...
def make_walking_engine(args: argparse.Namespace) -> DynamicWalkingEngine:
    ...
    return DynamicWalkingEngine(
        ...
        max_step_len=settings.walk_step_length_mm,
        max_turn_step_len=settings.max_turn_step_len,
        max_side_step_len=settings.max_side_step_len,
        step_height=settings.walk_step_height_mm,
        zmp_support_ratio=settings.zmp_support_ratio,
        ankle_roll_gain=settings.ankle_roll_gain,
        step_x_ratio=1.0,
        landing_gap_mm=settings.walk_step_length_mm,
        lift_start_phase=settings.walk_lift_start_phase,
        swing_advance_end_phase=settings.walk_swing_advance_end_phase,
        lift_end_phase=settings.walk_lift_end_phase,
        landing_roll_release_start=settings.walk_landing_roll_release_start,
        command_rate_limit=settings.command_rate_limit,
        max_leg_pwm_per_s=settings.walk_max_leg_pwm_per_s,
        ...
        prepare_hold_s=settings.walk_prepare_hold_s,
        prepare_step_s=settings.walk_prepare_step_s,
        prepare_lift_mm=settings.walk_prepare_lift_mm,
    )
